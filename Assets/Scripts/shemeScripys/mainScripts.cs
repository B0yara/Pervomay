...
public static class Moveble
{
    ...
    public static void MoveX2D(Transform t, float sens)
    {
    ...
    /// <param name="t"></param>
    /// <param name="sens"></param>
    public static void MoveY2D(Transform t, float sens)
    {
        Vector2 now = t.position;
        now.y = now.y + sens;
        t.position = now;
    }
    public static void MoveZ(Transform t, float sens)
    {
    ...
    /// <param name="t"></param>
    /// <param name="sens"></param>
    public static void Move2D(Transform t, Vector2 sens)
    {
    ...
    public static void Move3D(Transform t, Vector3 sens)
    {
        Vector3 nowPosition = t.position;
